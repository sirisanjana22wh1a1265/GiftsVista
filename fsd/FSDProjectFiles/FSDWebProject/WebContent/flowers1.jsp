...
<head>
    ...
    <title>Amber Embraced Mix Roses Bouquet</title>
    ...
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="productImage" src="https://assets.winni.in/product/primary/2023/1/81960.jpeg?dpr=1&w=500" alt="Golden Beads Personalized Photo Ear Rings">
            </div>
            <h2>Amber Embraced Mix Roses Bouquet</h2>
           
        </div>
    </div>
    <div class="product-details">
        <div class="product-title">Amber Embraced Mix Roses Bouquet</div>
        <div class="rating">Rating: 4.8 &#x2605; (6 Reviews)</div>
        <div class="price">&#8377; 799 <span class="original-price"></span> <span class="discount">30% off</span></div>
        ...
        <p><strong>No. of Stems:</strong> 12</p>
        <p><strong>Flowers Contain:</strong> 4 Red Roses, 3 Pink Roses, 2 White Roses, 3 Yellow Roses</p>
        ...
        <p><strong>Ribbons:</strong> Yellow</p>
