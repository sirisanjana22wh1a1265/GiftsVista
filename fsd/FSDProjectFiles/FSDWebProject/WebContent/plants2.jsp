...
<head>
    ...
    <title>Luck With Ficus Bonsai And Laughing Buddha</title>
    ...
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="productImage" src="https://assets.winni.in/product/primary/2014/6/33474.jpeg?dpr=1&w=500" alt="Luck With Ficus Bonsai And Laughing Buddha">
            </div>
            <h2>Luck With Ficus Bonsai And Laughing Buddha</h2>
           
        </div>
    </div>
    <div class="product-details">
        <div class="product-title">Luck With Ficus Bonsai And Laughing Buddha</div>
        <div class="price">&#8377; 1149 <span class="original-price"></span> <span class="discount"></span></div>
        ...
        <p><strong>Plant Name:</strong> Ficus Microcarpa</p>
        <p><strong>Plant Type:</strong> Bonsai</p>
        <p><strong>Plant Placement:</strong> Outdoors</p>
        <p><strong>Plant Height:</strong> Up to 18 inches</p>
        <p><strong>Planter:</strong> 5.7 inch Ronda No.14.5 Round Plastic Planter (White)</p>
        <p><strong>Extra:</strong> Laughing Buddha Idol will be sent as per availability</p>
</div>
