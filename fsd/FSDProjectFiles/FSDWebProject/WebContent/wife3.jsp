    ...
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="productImage" src="https://assets.winni.in/product/primary/2014/6/30536.jpeg?dpr=1&w=500" alt="Golden Beads Personalized Photo Ear Rings">
            </div>
            <h2>Glowing With Love</h2>
           
        </div>
    </div>
    <div class="product-details">
        <div class="product-title">Glowing With Love</div>
        <div class="rating">Rating: 4.8 &#x2605; (66 Reviews)</div>
        <div class="price">&#8377; 849 <span class="original-price"></span> <span class="discount">48% off</span></div>
        ...
        <div class="product-description">
            ...
            <p>Flower Type: Pink Roses</p>
            <p>No of Flower: 8</p>
            <p>Chocolate: 10 Dairy Milk Chocolates 13.2gms</p>
            <p>Fillers: Green Seasonal Fillers</p>
            <p>Shelf Life Chocolate - 11 Months</p>
            <p>Base: Round Oasis/Thermal Base</p>
            <p>Bow: Pink Ribbon</p>
        </div>
