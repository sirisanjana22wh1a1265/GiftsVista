...
<head>
    ...
    <title>Splendid Love Roses Bouquet</title>
    ...
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="productImage" src="https://assets.winni.in/product/primary/2023/1/81891.jpeg?dpr=1&w=500" alt="Golden Beads Personalized Photo Ear Rings">
            </div>
            <h2>Splendid Love Roses Bouquet</h2>
           
        </div>
    </div>
    <div class="product-details">
        <div class="product-title">Splendid Love Roses Bouquet</div>
        <div class="rating">Rating: 4.7 &#x2605; (7 Reviews)</div>
        <div class="price">&#8377; 699 <span class="original-price"></span> <span class="discount">26% off</span></div>
