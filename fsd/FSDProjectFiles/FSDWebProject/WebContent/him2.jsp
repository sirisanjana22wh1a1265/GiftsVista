...
<div class="container">
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="mainImage" src="https://assets.winni.in/product/primary/2014/8/35891.jpeg?dpr=1&w=500" alt="Birthday Butterscotch Cake">
            </div>
            <h2>Birthday Butterscotch Cake</h2>
            <div class="icons">
    ...
    <div class="product-details">
        <div class="product-title">Birthday Butterscotch Cake</div>
        <div class="rating">Rating: 4.6 &#x2605; </div>
        <div class="price">Rs. 575</div>
        <div class="weight-options">
            <button class="selected" data-price="575" data-weight="500">500 gm</button>
            <button data-price="1175" data-weight="1">1 kg</button>
            <button data-price="1775" data-weight="1.5">1.5 kg</button>
            <button data-price="2375" data-weight="2">2 kg</button>
            <button data-price="3575" data-weight="3">3 kg</button>
            <button data-price="4775" data-weight="4">4 kg</button>
        </div>
        ...
        <div class="product-images">
            ...
            <div class="thumbnails">
                <div class="thumbnail-images">
                    <img src="https://assets.winni.in/product/primary/2014/8/35891.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 1">
                    <img src="https://assets.winni.in/product/primary/2014/8/35890.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 2">
                </div>
            </div>
        </div>
        <div class="offers">
        ...
        <div class="product-description">
            ...
            <p>Filling in Layers: Butterscotch </p>
            <p>Toppings: Butterscotch , Red Cherry & Chocolate Flakes   </p>
        </div>
