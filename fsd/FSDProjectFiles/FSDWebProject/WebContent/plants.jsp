        ...
        <div class="husbandcontent">           
            <div class="product-grid">
                <div class="product">
                	<div id="product1">
                    <a href="plants1.jsp">
                        <img src="https://assets.winni.in/product/primary/2023/6/85448.jpeg?dpr=1&w=400" alt="Product 1" class="product-image">
                        <h2 class="product-title">Pleasing Peace Lily With Cute Monks</h2>
                ...
                <div id="product2">
                    <a href="plants2.jsp">
                        <img src="https://assets.winni.in/product/primary/2014/6/33474.jpeg?dpr=1&w=400" alt="Product 2" class="product-image">
                        <h2 class="product-title"><font size="3">Luck With Bonsai And Laughing Buddha</font></h2>
                ...
                <div id="product3">
                    <a href="plants3.jsp">
                        <img src="https://assets.winni.in/product/primary/2022/9/74165.jpeg?dpr=1&w=400" alt="Product 3" class="product-image">
                        <h2 class="product-title">Combo Of 3 Air Purifying</h2>
                ...
                <div id="product4">
                    <a href="plants4.jsp">
                        <img src="https://assets.winni.in/product/primary/2023/3/83804.jpeg?dpr=1&w=400" alt="Product 4" class="product-image">
                        <h2 class="product-title">Bunny Cactus Plant</h2>
                ...
                <div id="product5">
                    <a href="plants5.jsp">
                        <img src="https://assets.winni.in/product/primary/2014/10/48673.jpeg?dpr=1&w=400" alt="Product 5" class="product-image">
                        <h2 class="product-title">Mums Gratitude</h2>
                ...
                <div id="product6">
                    <a href="plants6.jsp">
                        <img src="https://assets.winni.in/product/primary/2022/6/61488.jpeg?dpr=1&w=400" alt="Product 6" class="product-image">
                        <h2 class="product-title">Indoor Air Purifier Plants For Home With Pots</h2>
                ...
                <div id="product7">
                    <a href="plants7.jsp">
                        <img src="https://assets.winni.in/product/primary/2024/3/94479.jpeg?dpr=1&w=400" alt="Product 7" class="product-image">
                        <h2 class="product-title">Hoya Plant In Red Pot</h2>
                ...
                <div id="product8">
                    <a href="plants8.jsp">
                        <img src="https://assets.winni.in/product/primary/2014/8/43154.jpeg?dpr=1&w=400" alt="Product 8" class="product-image">
                        <h2 class="product-title">Flowery Ixora Plant</h2>
                        <p class="product-price">&#8377; 579</p>
                    </a>
                    </div>
