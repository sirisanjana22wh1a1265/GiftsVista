...
<div class="container">
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="mainImage" src="https://assets.winni.in/product/primary/2022/6/61367.jpeg?dpr=1&w=500" alt="Birthday Personalised Cushion">
            </div>
            <h2>Birthday Personalised Cushion</h2>
            <div class="icons">
    ...
    <div class="product-details">
        <div class="product-title">Birthday Personalised Cushion</div>
        ...
        <div class="product-images">
            ...
            <div class="thumbnails">
                <div class="thumbnail-images">
                    <img src="https://assets.winni.in/product/primary/2022/6/61367.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 1">
                    <img src="https://assets.winni.in/product/primary/2022/6/61374.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 2">
                </div>
            </div>
        </div>
        <div class="offers">
        ...
        <div class="product-description">
            ...
            <p>1 Personalized Photo Cushion </p>
            <p>Material outside- Canvas Poly Duck  </p>
            <p>Material inside- Recron Filled Cushion</p>
            <p>Dimensions (L x W)- 12 x 12 inches</p>
        </div>
