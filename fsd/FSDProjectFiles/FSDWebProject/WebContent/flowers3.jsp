...
<head>
    ...
    <title>Beautiful Pink Lilies Bunch</title>
    ...
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="productImage" src="https://assets.winni.in/product/primary/2022/9/73203.jpeg?dpr=1&w=500" alt="Golden Beads Personalized Photo Ear Rings">
            </div>
            <h2>Beautiful Pink Lilies Bunch</h2>
           
        </div>
    </div>
    <div class="product-details">
        <div class="product-title">Beautiful Pink Lilies Bunch</div>
        <div class="rating">Rating: 5.0 &#x2605; (3 Reviews)</div>
        <div class="price">&#8377; 1899 <span class="original-price"></span> <span class="discount">17% off</span></div>
        ...
        <p><strong>Flower Type:</strong> Pink Lilies</p>
        <p><strong>No. of Stems:</strong> 6</p>
        <p><strong>Fillers:</strong> Green Seasonal Fillers</p>
        <p><strong>Packing:</strong> 2 Layer</p>
        <p><strong>Packing Color:</strong> Pink</p>
        <p><strong>No. of Packing:</strong> 2 Layer</p>
        <p><strong>Ribbons:</strong> Pink</p>
