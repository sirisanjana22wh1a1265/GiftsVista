...
<head>
    ...
    <title>Hoya Plant In Red Pot</title>
    ...
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="productImage" src="https://assets.winni.in/product/primary/2024/3/94479.jpeg?dpr=1&w=500" alt="Hoya Plant In Red Pot">
            </div>
            <h2>Hoya Plant In Red Pot</h2>
           
        </div>
    </div>
    <div class="product-details">
        <div class="product-title">Hoya Plant In Red Pot</div>
        <div class="rating"></div>
        <div class="price">&#8377;599 <span class="original-price"></span> <span class="discount"></span></div>
        ...
        <p><strong>Plant Name:</strong> Love Bonding Hoya</p>
        <p><strong>Plant Height:</strong> 3-4 Inches Approx.</p>
        <p><strong>Plant Type:</strong> Succulent</p>
        <p><strong>Plant Location:</strong> Indoor</p>
        <p><strong>Vase Height:</strong> 3.5 Inches</p>
        <p><strong>Vase Material:</strong> Red Self-Watering Plastic Pot</p>
        <p><strong>Special Note:</strong> Celebrate your Love Bonding with Hoya Heart Plant</p>
    </div>
</div>
