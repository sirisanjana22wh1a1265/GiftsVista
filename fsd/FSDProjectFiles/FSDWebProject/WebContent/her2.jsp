...
<div class="container">
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="mainImage" src="https://assets.winni.in/product/primary/2023/10/89981.jpeg?dpr=1&w=500" alt="Mixed Rose Bouquet With Vanilla Cake">
            </div>
            <h2>Mixed Rose Bouquet With Vanilla Cake</h2>
            <div class="icons">
    ...
    <div class="product-details">
        <div class="product-title">Mixed Rose Bouquet With Vanilla Cake</div>
        <div class="rating">Rating: 4.5 &#x2605; (4 Reviews)</div>
        <div class="price">Rs. 649</div>
        <div class="weight-options">
            <button class="selected" data-price="649" data-weight="500">500 gm</button>
            <button data-price="1299" data-weight="1">1 kg</button>
            <button data-price="1949" data-weight="1.5">1.5 kg</button>
            <button data-price="2599" data-weight="2">2 kg</button>
            <button data-price="2899" data-weight="3">3 kg</button>
            <button data-price="5199" data-weight="4">4 kg</button>
        </div>
        ...
        <div class="product-images">
            ...
            <div class="thumbnails">
                <div class="thumbnail-images">
                    <img src="https://assets.winni.in/product/primary/2023/10/89981.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 1">
                    <img src="https://assets.winni.in/product/primary/2023/10/89990.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 2">
                    <img src="https://assets.winni.in/product/primary/2023/10/89991.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 3">
                </div>
            </div>
        </div>
        <div class="offers">
        ...
        <div class="product-description">
            ...
            <p>Flower Type: Mixed Roses </p>
            <p>No. of Stems: 10 </p>
            <p>Flowers Contains: 3 Red Roses, 3 Pink Roses , 2 White Roses,2 Yellow Roses </p>
            <p>Fillers: Green Seasonal Fillers</p>
            <p>Cake Flavour: Vanilla  </p>
            <p>Shape: Round </p>
