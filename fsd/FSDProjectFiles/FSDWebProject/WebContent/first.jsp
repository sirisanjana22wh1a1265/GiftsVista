        ...
        <div class="husbandcontent">           
            <div class="product-grid">
                <div class="product">
                	<div id="product1">
                    <a href="flowers1.jsp">
                        <img src="https://assets.winni.in/product/primary/2023/1/81960.jpeg?dpr=1&w=400" alt="Product 1" class="product-image">
                        <h2 class="product-title">Amber Embraced Mix Roses Bouquet</h2>
                ...
                <div id="product2">
                    <a href="flowers2.jsp">
                        <img src="https://assets.winni.in/product/primary/2023/1/81906.jpeg?dpr=1&w=400" alt="Product 2" class="product-image">
                        <h2 class="product-title"><font size="3">Mystique 8 Red Roses Bouquet</font></h2>
                ...
                <div id="product3">
                    <a href="flowers3.jsp">
                        <img src="https://assets.winni.in/product/primary/2021/10/54302.jpeg?dpr=1&w=400" alt="Product 3" class="product-image">
                        <h2 class="product-title">Vibrant Blue Orchids</h2>
                ...
                <div id="product4">
                    <a href="flowers4.jsp">
                        <img src="https://assets.winni.in/product/primary/2022/9/73203.jpeg?dpr=1&w=400" alt="Product 4" class="product-image">
                        <h2 class="product-title">Beautiful Pink Lilies Bunch</h2>
                ...
                <div id="product5">
                    <a href="flowers5.jsp">
                        <img src="https://assets.winni.in/product/primary/2022/9/73371.png?dpr=1&w=400" alt="Product 5" class="product-image">
                        <h2 class="product-title">Mixed Roses Arrangement</h2>
                ...
                <div id="product6">
                    <a href="flowers6.jsp">
                        <img src="https://assets.winni.in/product/primary/2023/1/81891.jpeg?dpr=1&w=400" alt="Product 6" class="product-image">
                        <h2 class="product-title">Splendid Love Roses Bouquet</h2>
                ...
                <div id="product7">
                    <a href="flowers7.jsp">
                        <img src="https://assets.winni.in/product/primary/2023/1/81903.jpeg?dpr=1&w=400" alt="Product 7" class="product-image">
                        <h2 class="product-title">Love Affair Of Roses And Chocolates Bouquet</h2>
                        <p class="product-price">&#8377; 879</p>
                    </a>
                    </div>
                ...
                <div id="product8">
                    <a href="flowers8.jsp">
                        <img src="https://assets.winni.in/product/primary/2014/6/29518.jpeg?dpr=1&w=400" alt="Product 8" class="product-image">
                        <h2 class="product-title">Modern Romance Bouquet</h2>
