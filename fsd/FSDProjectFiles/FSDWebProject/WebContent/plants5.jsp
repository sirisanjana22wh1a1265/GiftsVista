    ...
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="productImage" src="https://assets.winni.in/product/primary/2014/10/48673.jpeg?dpr=1&w=500" alt="Mums Gratitude">
            </div>
            <h2>Mums Gratitude</h2>
           
        </div>
    </div>
    <div class="product-details">
        <div class="product-title">Mums Gratitude</div>
        ...
        <p><strong>Plant Name:</strong> Rose Plant (Red)</p>
        <p><strong>Plant Type:</strong> Flowering Plant</p>
        <p><strong>Plant Placement:</strong> Outdoors</p>
        <p><strong>Plant Height:</strong> Up to 12 inches</p>
        <p><strong>Pot:</strong> Medium Size Ceramic Pot</p>
        <p><strong>Special Feature:</strong> "Best Mom Ever" Message</p>
        <p><strong>Included:</strong> Winni Message Card</p>
    </div>
</div>
