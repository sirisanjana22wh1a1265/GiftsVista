...
<head>
    ...
    <title>Vibrant Blue Orchids</title>
    ...
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="productImage" src="https://assets.winni.in/product/primary/2021/10/54302.jpeg?dpr=1&w=500" alt="Golden Beads Personalized Photo Ear Rings">
            </div>
            <h2>Vibrant Blue Orchids</h2>
           
        </div>
    </div>
    <div class="product-details">
        <div class="product-title">Vibrant Blue Orchids</div>
        <div class="rating">Rating: 4.8 &#x2605; (40 Reviews)</div>
        <div class="price">&#8377; 1499 <span class="original-price"></span> <span class="discount">25% off</span></div>
        ...
        <p><strong>Flower Type:</strong> Blue Orchids</p>
        ...
        <p><strong>Packing Color:</strong> Mixed</p>
        <p><strong>No. of Packing:</strong> 2 Layer</p>
        <p><strong>Ribbons:</strong> Blue</p>
