...
<head>
    ...
    <title>8 Red Roses Bouquet</title>
    ...
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="productImage" src="https://assets.winni.in/product/primary/2023/1/82083.jpeg?dpr=1&w=500" alt="Golden Beads Personalized Photo Ear Rings">
            </div>
            <h2>8 Red Roses Bouquet</h2>
           
        </div>
    </div>
    <div class="product-details">
        <div class="product-title">8 Red Roses Bouquet</div>
        <div class="rating">Rating: 4.6 &#x2605; (297 Reviews)</div>
        <div class="price">&#8377; 579 <span class="original-price"></span> <span class="discount">17% off</span></div>
        ...
        <p><strong>Packing Color:</strong> Red</p>
        <p><strong>No. of Packing:</strong> 2 Layer</p>
        <p><strong>Ribbons:</strong> White</p>
