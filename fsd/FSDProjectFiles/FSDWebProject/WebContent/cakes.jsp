        ...
        <div class="husbandcontent">           
            <div class="product-grid">
                <div class="product">
                	<div id="product1">
                    <a href="#">
                        <img src="https://assets.winni.in/product/primary/2023/3/83221.jpeg?dpr=1&w=500" alt="Product 1" class="product-image">
                        <h2 class="product-title"> Yummy Chocolate Cake</h2>
                ...
                <div id="product2">
                    <a href="husband2.jsp">
                        <img src="https://assets.winni.in/product/primary/2023/5/84880.jpeg?dpr=1&w=400" alt="Product 2" class="product-image">
                        <h2 class="product-title"><font size="3">Red Velvet Cake</font></h2>
                ...
                <div id="product3">
                    <a href="husband3.jsp">
                        <img src="https://assets.winni.in/product/primary/2024/3/94573.jpeg?dpr=1&w=400" alt="Product 3" class="product-image">
                        <h2 class="product-title">Strawberry Flavoured Cake</h2>
                ...
                <div id="product4">
                    <a href="husband4.jsp">
                        <img src="https://assets.winni.in/product/primary/2024/3/94560.jpeg?dpr=1&w=400" alt="Product 4" class="product-image">
                        <h2 class="product-title">Butterscotch Flavoured Cake</h2>
                        <p class="product-price">&#8377; 849</p>
                    </a>
                    </div>
                ...
                <div id="product5">
                    <a href="husband5.jsp">
                        <img src="https://assets.winni.in/product/primary/2023/10/90477.jpeg?dpr=1&w=400" alt="Product 5" class="product-image">
                        <h2 class="product-title">Fruit cake</h2>
                ...
                <div id="product6">
                    <a href="husband6.jsp">
                        <img src="https://assets.winni.in/product/primary/2023/5/84770.jpeg?dpr=1&w=400" alt="Product 6" class="product-image">
                        <h2 class="product-title">Yummy Mango Flavoured Cake</h2>
                ...
                <div id="product7">
                    <a href="husband7.jsp">
                        <img src="https://assets.winni.in/product/primary/2014/6/31204.jpeg?dpr=1&w=400" alt="Product 7" class="product-image">
                        <h2 class="product-title">Truffle Cake</h2>
                ...
                <div id="product8">
                    <a href="husband8.jsp">
                        <img src="https://assets.winni.in/product/primary/2023/3/83233.jpeg?dpr=1&w=400" alt="Product 8" class="product-image">
                        <h2 class="product-title">Black Forest Cake</h2>
