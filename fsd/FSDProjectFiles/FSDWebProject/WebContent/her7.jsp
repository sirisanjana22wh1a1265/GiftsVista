...
<div class="container">
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="mainImage" src="https://assets.winni.in/product/primary/2024/2/93716.jpeg?dpr=1&w=500" alt="Heavy Chocolate Love Bouquet">
            </div>
            <h2>Heavy Chocolate Love Bouquet</h2>
            <div class="icons">
    ...
    <div class="product-details">
        <div class="product-title">Heavy Chocolate Love Bouquet</div>
        <div class="rating">Rating: 4.4 &#x2605; (9 Reviews)</div>
        ...
        <div class="product-images">
            ...
            <div class="thumbnails">
                <div class="thumbnail-images">
                    <img src="https://assets.winni.in/product/primary/2024/2/93716.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 1">
                    <img src="https://assets.winni.in/product/primary/2024/2/93718.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 2">
                    <img src="https://assets.winni.in/product/primary/2024/2/93717.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 3">
                </div>
            </div>
        </div>
        <div class="offers">
        ...
        <div class="product-description">
            ...
            <p>2 Kitkat Chocolate (Each 11.9g ) </p>
            <p>2 Five Star Chocolate (Each 22g )</p>
            <p>4 Dairy Milk Chocolate (Each 13.2g )</p>
            <p>One White Mug with handle red ribbon  </p>
        </div>
