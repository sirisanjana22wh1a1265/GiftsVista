...
<div class="container">
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="mainImage" src="https://assets.winni.in/product/primary/2021/12/57311.jpeg?dpr=1&w=500" alt="Heart Birthday Keychain">
            </div>
            <h2>Heart Birthday Keychain</h2>
            <div class="icons">
    ...
    <div class="product-details">
        <div class="product-title">Heart Birthday Keychain</div>
        ...
        <div class="product-images">
            ...
            <div class="thumbnails">
                <div class="thumbnail-images">
                    <img src="https://assets.winni.in/product/primary/2021/12/57311.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 1">
                </div>
            </div>
        </div>
        <div class="offers">
        ...
        <div class="product-description">
            ...
            <p>Shape: Heart-Shape</p>
            <p>Product-Type: Key Chain</p>
            <p>Size: Weight 5.5cm /Height 5 cm</p>
            <p>Material: Hardened MDF</p>
        </div>
    </div>
</div>
