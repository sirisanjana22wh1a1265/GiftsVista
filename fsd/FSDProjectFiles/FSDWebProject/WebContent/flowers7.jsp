...
<head>
    ...
    <title>Love Affair Of Roses And Chocolates Bouquet</title>
    ...
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="productImage" src="https://assets.winni.in/product/primary/2023/1/81903.jpeg?dpr=1&w=500" alt="Golden Beads Personalized Photo Ear Rings">
            </div>
            <h2>Love Affair Of Roses And Chocolates Bouquet</h2>
           
        </div>
    </div>
    <div class="product-details">
        <div class="product-title">Love Affair Of Roses And Chocolates Bouquet</div>
        <div class="rating">Rating: 4.5 &#x2605; (39 Reviews)</div>
        <div class="price">&#8377; 879 <span class="original-price"></span> <span class="discount">19% off</span></div>
        ...
        <p><strong>Flower Sticks:</strong> 6</p>
        <p><strong>Chocolate:</strong> 6 Cadbury Dairy Milk Chocolate (24 gm each)</p>
        <p><strong>Fillers:</strong> Green Seasonal Fillers</p>
        <p><strong>Shelf Life:</strong> 11 Months</p>
        <p><strong>Packing:</strong> 2 Layer White Paper Packing</p>
        <p><strong>Bow:</strong> Red Ribbon</p>
</div>
