    ...
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="productImage" src="https://assets.winni.in/product/primary/2014/6/29518.jpeg?dpr=1&w=500" alt="Golden Beads Personalized Photo Ear Rings">
            </div>
            <h2>Modern Romance</h2>
           
        </div>
    </div>
    <div class="product-details">
        <div class="product-title">Modern Romance</div>
        <div class="rating">Rating: 4.7 &#x2605; (163 Reviews)</div>
        <div class="price">&#8377; 629 <span class="original-price"></span> <span class="discount">28% off</span></div>
        ...
        <p><strong>No. of Stems:</strong> 10</p>
        <p><strong>Flowers Contains:</strong> 3 Red Roses, 2 White Roses, 3 Pink Roses, 2 Yellow Roses</p>
        <p><strong>Fillers:</strong> Green Seasonal Fillers</p>
        <p><strong>Packing:</strong> Non Woven Fabric</p>
        <p><strong>Packing Color:</strong> White</p>
