...
<head>
    ...
    <title>Butterscotch Flavorsome Cake</title>
    ...
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img src="https://assets.winni.in/product/primary/2024/3/94560.jpeg?dpr=1&w=500" alt="Wife Special Chocolate Truffle Cake">
            </div>
            <h2>Butterscotch Flavorsome Cake</h2>
           
        </div>
    </div>
    <div class="product-details">
        <div class="product-title">Butterscotch Flavorsome Cake</div>
        <div class="rating">Rating: 4.6 &#x2605; (186 Reviews)</div>
        <div class="price">&#8377; 589</div>
        <div class="weight-options">
            <button class="selected" data-price="749" data-weight="500">500 gm</button>
            <button data-price="1189" data-weight="1">1 kg</button>
            <button data-price="1789" data-weight="1.5">1.5 kg</button>
            <button data-price="2389" data-weight="2">2 kg</button>
            <button data-price="3589" data-weight="3">3 kg</button>
            <button data-price="4789" data-weight="4">4 kg</button>
        </div>
        ...
        <p><strong>Cake Flavour:</strong> Butterscotch</p>
        <p><strong>Shape:</strong> Round</p>
        <p><strong>Type of Cake:</strong> Cream</p>
        <p><strong>Type of Sponge:</strong> Vanilla</p>
        <p><strong>Type of Cream:</strong> Vanilla</p>
        <p><strong>Filling in Layers:</strong> Butterscotch</p>
        <p><strong>Toppings:</strong> Butterscotch, Cherry, Chocolate & Choco Chip</p>
        <p><strong>Net Quantity:</strong> 1 Cake</p>
