...
<head>
    ...
    <title>Bunny Cactus Plant</title>
...
<div class="container">
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="productImage" src="https://assets.winni.in/product/primary/2023/3/83804.jpeg?dpr=1&w=500" alt="Bunny Cactus Plant">
            </div>
    ...
    <div class="product-details">
        <div class="product-title">Bunny Cactus Plant</div>
        <div class="rating"></div>
        <div class="price">&#8377;399 <span class="original-price"></span> <span class="discount"></span></div>
        ...
        <p><strong>Common Names:</strong> Bunny ears, Angels wings, golden-bristle cactus, polka-dot cactus</p>
        <p><strong>Plant Height:</strong> 4 inches (10 cm)</p>
        <p><strong>Plant Spread:</strong> 3 inches (8 cm)</p>
        <p><strong>Pot Size:</strong> 4 inches approx.</p>
        <p><strong>Flower Colour:</strong> Yellow</p>
        <p><strong>Bloom Time:</strong> April to May</p>
        <p><strong>Difficulty Level:</strong> Easy to grow</p>
    </div>
</div>
