...
<div class="container">
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="mainImage" src="https://assets.winni.in/product/primary/2023/6/85453.jpeg?dpr=1&w=500" alt="Pretty Personalised Photo Frame For Her">
            </div>
            <h2>Pretty Personalised Photo Frame For Her</h2>
            <div class="icons">
    ...
    <div class="product-details">
        <div class="product-title">Pretty Personalised Photo Frame For Her</div>
            ...
            <div class="thumbnails">
                <div class="thumbnails">
                    <div class="thumbnail-images">
                        <img src="https://assets.winni.in/product/primary/2023/6/85453.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 1">                        </div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="product-description">
            ...
            <p>Color -  Black</p>
            <p>Occasion  -  All Occasions</p>
            <p>Weight  -  300 Grams            </p>
            <p>Size: 10 X 12 Inch approx. </p>
