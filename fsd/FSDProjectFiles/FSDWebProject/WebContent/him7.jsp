...
<div class="container">
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="mainImage" src="https://assets.winni.in/product/primary/2023/1/82027.jpeg?dpr=1&w=500" alt="Hypnotic Red Roses Box">
            </div>
            <h2>Hypnotic Red Roses Box</h2>
            <div class="icons">
    ...
    <div class="product-details">
        <div class="product-title">Hypnotic Red Roses Box</div>
        ...
        <div class="product-images">
            ...
            <div class="thumbnails">
                <div class="thumbnail-images">
                    <img src="https://assets.winni.in/product/primary/2023/1/82027.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 1">
                    <img src="	https://assets.winni.in/product/primary/2023/3/83531.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 2">
                    <img src="https://assets.winni.in/product/primary/2023/1/82028.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 3">
                </div>
            </div>
        </div>
        <div class="offers">
