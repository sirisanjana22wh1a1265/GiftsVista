...
<head>
    ...
    <title>Delight Assorted Chocolate Box</title>
    ...
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="productImage" src="https://assets.winni.in/product/primary/2022/2/57895.jpeg?dpr=1&w=500" alt="Golden Beads Personalized Photo Ear Rings">
            </div>
            <h2>Delight Assorted Chocolate Box</h2>
           
        </div>
    </div>
    <div class="product-details">
        <div class="product-title">Delight Assorted Chocolate Box</div>
        <div class="rating">Rating: 4.5 &#x2605; (22 Reviews)</div>
        <div class="price">&#8377; 499 <span class="original-price"></span> <span class="discount">33% off</span></div>
        ...
        <p><strong>Type:</strong> Chocolate Truffles</p>
        <p><strong>Model Name:</strong> Premium Chocolate Gift Box (Pack of 12)</p>
        <p><strong>Maximum Shelf Life:</strong> 6 Months</p>
        <p><strong>Gourmet:</strong> Yes</p>
        <p><strong>With Nuts:</strong> Yes</p>
        <p><strong>Gift Pack:</strong> Yes</p>
        <p><strong>Food Preference:</strong> Vegetarian</p>
        <p><strong>Ingredients:</strong> Chocolate</p>
