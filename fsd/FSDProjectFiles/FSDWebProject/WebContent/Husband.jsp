        ...
        <div class="husbandcontent">           
            <div class="product-grid">
                <div class="product">
                	<div id="product1">
                    <a href="HusProd1.jsp">
                        <img src="https://assets.winni.in/product/primary/2022/2/57873.jpeg?dpr=1&w=400" alt="Product 1" class="product-image">
                        <h2 class="product-title">Love You Mug</h2>
                ...
                <div id="product2">
                    <a href="husband2.jsp">
                        <img src="	https://assets.winni.in/product/primary/2023/6/85584.jpeg?dpr=1&w=400" alt="Product 2" class="product-image">
                        <h2 class="product-title"><font size="3">Scrumptious Pineapple Cake</font></h2>
                ...
                <div id="product3">
                    <a href="husband3.jsp">
                        <img src="https://assets.winni.in/product/primary/2021/11/55779.jpeg?dpr=1&w=400" alt="Product 3" class="product-image">
                        <h2 class="product-title">Personalized Love Cushion</h2>
                ...
                <div id="product4">
                    <a href="husband4.jsp">
                        <img src="https://assets.winni.in/product/primary/2024/2/93884.jpeg?dpr=1&w=400" alt="Product 4" class="product-image">
                        <h2 class="product-title">Only 4 You</h2>
                ...
                <div id="product6">
                    <a href="husband6.jsp">
                        <img src="https://assets.winni.in/product/primary/2023/1/81888.jpeg?dpr=1&w=400" alt="Product 6" class="product-image">
                        <h2 class="product-title">Classic Aura 12 Red Roses Bouquet</h2>
                ...
                <div id="product7">
                    <a href="husband7.jsp">
                        <img src="https://assets.winni.in/product/primary/2023/1/81690.jpeg?dpr=1&w=400" alt="Product 7" class="product-image">
                        <h2 class="product-title">Little Hearts Hoya Plants</h2>
                ...
                <div id="product8">
                    <a href="husband8.jsp">
                        <img src="https://assets.winni.in/product/primary/2022/3/58070.jpeg?dpr=1&w=400" alt="Product 8" class="product-image">
                        <h2 class="product-title">Fragrance Brown Ball Diffuser</h2>
