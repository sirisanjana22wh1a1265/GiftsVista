...
<div class="container">
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="mainImage" src="https://assets.winni.in/product/primary/2024/1/93497.jpeg?dpr=1&w=500" alt="Premium Truffle Box With Hearts Chocolates 6 Pcs">
            </div>
            <h2>Premium Truffle Box With Hearts Chocolates 6 Pcs</h2>
            <div class="icons">
    ...
    <div class="product-details">
        <div class="product-title">Premium Truffle Box With Hearts Chocolates 6 Pcs</div>
            ...
            <div class="thumbnails">
                <div class="thumbnails">
                    <div class="thumbnail-images">
                        <img src="https://assets.winni.in/product/primary/2024/1/93497.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 1">
                        <img src="https://assets.winni.in/product/primary/2024/1/93496.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 2">
                        <img src="https://assets.winni.in/product/primary/2024/1/93498.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 3">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="product-description">
            ...
            <p>Type - Chocolate Truffles</p>
            <p>Model Name-Premium Chocolate Gift Box ( Pack of 6 )</p>
            <p>Chocolate Flavours – Roasted DryFruits , Cranberry Filling , Butterscotch Filling, Mix Fruits Filling</p>
            <p>3 Pcs heartshape and 3 round shape</p>
        </div>
