        ...
        <div class="husbandcontent">           
            <div class="product-grid">
                <div class="product">
                	<div id="product1">
                    <a href="#">
                        <img src="https://assets.winni.in/product/primary/2014/10/48556.jpeg?dpr=1&w=400" alt="Product 1" class="product-image">
                        <h2 class="product-title">Heart Pendants</h2>
                ...
                <div id="product2">
                    <a href="husband2.jsp">
                        <img src="https://assets.winni.in/product/primary/2014/10/48615.jpeg?dpr=1&w=400" alt="Product 2" class="product-image">
                        <h2 class="product-title"><font size="3">Drop Earring</font></h2>
                ...
                <div id="product3">
                    <a href="husband3.jsp">
                        <img src="https://assets.winni.in/product/primary/2021/10/55230.jpeg?dpr=1&w=400" alt="Product 3" class="product-image">
                        <h2 class="product-title">Stone Ring Combo</h2>
                ...
                <div id="product4">
                    <a href="husband4.jsp">
                        <img src="https://assets.winni.in/product/primary/2024/1/93432.jpeg?dpr=1&w=400" alt="Product 4" class="product-image">
                        <h2 class="product-title">Mens Silver Bracelet</h2>
                        <p class="product-price">&#8377; 6,849</p>
                    </a>
                    </div>
                ...
                <div id="product5">
                    <a href="husband5.jsp">
                        <img src="https://assets.winni.in/product/primary/2014/10/48596.jpeg?dpr=1&w=400" alt="Product 5" class="product-image">
                        <h2 class="product-title">Eye Catching Earrings</h2>
                ...
                <div id="product6">
                    <a href="husband6.jsp">
                        <img src="https://assets.winni.in/product/primary/2014/10/49578.jpeg?dpr=1&w=400" alt="Product 6" class="product-image">
                        <h2 class="product-title">Olive Green Crystal Ring</h2>
