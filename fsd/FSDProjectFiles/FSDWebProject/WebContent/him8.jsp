...
<div class="container">
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="mainImage" src="https://assets.winni.in/product/primary/2024/5/95479.jpeg?dpr=1&w=500" alt="Personalised Mug With Black Forest Cake">
            </div>
            <h2>Personalised Mug With Black Forest Cake</h2>
            <div class="icons">
    ...
    <div class="product-details">
        <div class="product-title">Personalised Mug With Black Forest Cake</div>
        <div class="rating">Rating: 4.5 &#x2605; (4 Reviews)</div>
        <div class="price">Rs. 1099</div>
        <div class="weight-options">
            <button class="selected" data-price="1099" data-weight="500">500 gm</button>
            <button data-price="1649" data-weight="1">1 kg</button>
            <button data-price="2199" data-weight="1.5">1.5 kg</button>
            <button data-price="2749" data-weight="2">2 kg</button>
            <button data-price="3849" data-weight="3">3 kg</button>
            <button data-price="4949" data-weight="4">4 kg</button>
        </div>
        ...
        <div class="product-images">
            ...
            <div class="thumbnails">
                <div class="thumbnail-images">
                    <img src="https://assets.winni.in/product/primary/2024/5/95479.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 1">
                    <img src="https://assets.winni.in/product/primary/2024/5/95480.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 2">
                    <img src="https://assets.winni.in/product/primary/2024/5/95481.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 3">
                </div>
            </div>
        </div>
        <div class="offers">
