...
<head>
    ...
    <title>Personalised Super Girl Mug</title>
    ...
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="productImage" src="https://assets.winni.in/product/primary/2021/11/55833.jpeg?dpr=1&w=500" alt="Golden Beads Personalized Photo Ear Rings">
            </div>
            <h2>Personalised Super Girl Mug</h2>
           
        </div>
    </div>
    <div class="product-details">
        <div class="product-title">Personalised Super Girl Mug</div>
        <div class="rating">Rating: 4.2 &#x2605; (10 Reviews)</div>
        <div class="price">&#8377; 249 <span class="original-price"></span> <span class="discount">31% off</span></div>
        ...
        <p><strong>Product:</strong> One Personalised Mug</p>
        <p><strong>Qty:</strong> 1</p>
        <p><strong>Material:</strong> Ceramic</p>
        <p><strong>Set Type:</strong> Single</p>
        <p><strong>Style:</strong> Designer</p>
        <p><strong>Occasions:</strong> Best for all occasions</p>
        <p><strong>Dimensions (H x D):</strong> 4 x 3 inches</p>
        <p><strong>Capacity:</strong> Can hold liquid up to 325 ml</p>
        <p><strong>Product Type:</strong> Personalized Photo Mug</p>
    </div>
