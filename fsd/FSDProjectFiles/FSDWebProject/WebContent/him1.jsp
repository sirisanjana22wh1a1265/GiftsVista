...
<head>
    ...
    <style>
        ...
        .message-on-photo input[type="text"],
        .check-delivery button,
        .message-on-photo button,
        .add-to-cart button {
            margin-top: 10px;
...
<div class="container">
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="mainImage" src="https://assets.winni.in/product/primary/2022/9/74488.jpeg?dpr=1&w=500" alt="Insertable Photo Frame">
            </div>
            <h2>Insertable Photo Frame</h2>
            <div class="icons">
    ...
    <div class="product-details">
        <div class="product-title">Insertable Photo Frame</div>
        <div class="rating">Rating: 4.4 &#x2605; (4 Reviews)</div>
        <div class="price">Rs. 1399</div>
        
        <div class="message-on-photo">
            <input type="text" placeholder="Message on photo">
        </div>
        ...
        <div class="product-images">
            ...
            <div class="thumbnails">
                <div class="thumbnail-images">
                    <img src="https://assets.winni.in/product/primary/2022/9/74488.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 1">
                    <img src="https://assets.winni.in/product/primary/2022/9/74501.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 2">
                    <img src="https://assets.winni.in/product/primary/2022/9/74489.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 3">
                </div>
            </div>
        </div>
        <div class="offers">
        ...
        <div class="product-description">
            ...
            <p>1 Photo Frame</p>
            <p>Acrylic and raw wooden curved base</p>
            <p>Size- 6" height x 4" width x 2" depth</p>
            <p>Personalized with one photo</p>
        </div>
    </div>
</div>
...
<script>
    ...
    const thumbnails = document.querySelectorAll('.thumbnail'); // Corrected selector
