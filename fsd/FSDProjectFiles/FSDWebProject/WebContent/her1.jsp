...
<div class="container">
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="mainImage" src="https://assets.winni.in/product/primary/2024/4/95063.jpeg?dpr=1&w=500" alt="Butterscotch Birthday Delight">
            </div>
            <h2>Butterscotch Birthday Delight</h2>
            <div class="icons">
    ...
    <div class="product-details">
        <div class="product-title">Butterscotch Birthday Delight</div>
        ...
        <div class="product-images">
            ...
            <div class="thumbnails">
                <div class="thumbnail-images">
                    <img src="https://assets.winni.in/product/primary/2024/4/95063.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 1">
                    <img src="https://assets.winni.in/product/primary/2024/4/95062.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 2">
                    <img src="https://assets.winni.in/product/primary/2024/4/95061.jpeg?dpr=1&w=500" class="thumbnail" alt="Thumbnail 3">
                </div>
            </div>
        </div>
        <div class="offers">
        ...
        <div class="product-description">
            ...
            <p>Cake Flavour: Butterscotch</p>
            <p>Shape: Round</p>
            <p>Type of Cake: Cream</p>
            <p>Type of Sponge: Vanilla</p>
        </div>
