...
<head>
    ...
    <title>Flowery Ixora Plant</title>
    ...
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="productImage" src="https://assets.winni.in/product/primary/2014/8/43154.jpeg?dpr=1&w=500" alt="Flowery Ixora Plant">
            </div>
            <h2>Flowery Ixora Plant</h2>
           
        </div>
    </div>
    <div class="product-details">
        <div class="product-title">Flowery Ixora Plant</div>
        <div class="rating"></div>
        <div class="price">&#8377;649 <span class="original-price"></span> <span class="discount"></span></div>
