...
<head>
    ...
    <title>Mixed Roses Arrangement</title>
    ...
    <div class="card">
        <div class="border">
            <div class="image-container">
                <img id="productImage" src="https://assets.winni.in/product/primary/2022/9/73371.png?dpr=1&w=500" alt="Golden Beads Personalized Photo Ear Rings">
            </div>
            <h2>Mixed Roses Arrangement</h2>
           
        </div>
    </div>
    <div class="product-details">
        <div class="product-title">Mixed Roses Arrangement</div>
        <div class="rating">Rating: 4.3 &#x2605; (22 Reviews)</div>
        <div class="price">&#8377; 1299 <span class="original-price"></span> <span class="discount">21% off</span></div>
        ...
        <p><strong>Flower Type:</strong> Mixed Roses</p>
        <p><strong>No. of Flowers:</strong> 14</p>
        <p><strong>Fillers:</strong> Seasonal Fillers</p>
        <p><strong>Base:</strong> Cane Basket</p>
        <p><strong>Chocolate:</strong> 5 Dairy Milk Chocolates - 13.2 g each</p>
        <p><strong>Shelf Life for Chocolate:</strong> 11 Months</p>
