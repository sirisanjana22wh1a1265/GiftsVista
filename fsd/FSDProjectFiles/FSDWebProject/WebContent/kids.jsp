        ...
        <div class="husbandcontent">           
            <div class="product-grid">
                <div class="product">
                	<div id="product1">
                    <a href="HusProd1.jsp">
                        <img src="https://assets.winni.in/product/primary/2022/6/61368.jpeg?dpr=1&w=400" alt="Product 1" class="product-image">
                        <h2 class="product-title">Birthday Photo Cushion</h2>
                ...
                <div id="product2">
                    <a href="husband2.jsp">
                        <img src="https://assets.winni.in/product/primary/2022/5/60764.jpeg?dpr=1&w=400" alt="Product 2" class="product-image">
                        <h2 class="product-title"><font size="3">Personalised Birthday Kid Mug</font></h2>
                ...
                <div id="product3">
                    <a href="husband3.jsp">
                        <img src="https://assets.winni.in/product/primary/2014/8/41612.jpeg?dpr=1&w=400" alt="Product 3" class="product-image">
                        <h2 class="product-title">Happy Birthday Photo Cake</h2>
                ...
                <div id="product4">
                    <a href="husband4.jsp">
                        <img src="https://assets.winni.in/product/primary/2022/11/79764.jpeg?dpr=1&w=400" alt="Product 4" class="product-image">
                        <h2 class="product-title">Football Pinata Cake</h2>
                ...
                <div id="product5">
                    <a href="husband5.jsp">
                        <img src="https://assets.winni.in/product/primary/2022/1/57326.jpeg?dpr=1&w=400" alt="Product 5" class="product-image">
                        <h2 class="product-title">Birthday Beautiful Balloon Decoration</h2>
                ...
                <div id="product6">
                    <a href="husband6.jsp">
                        <img src="https://assets.winni.in/product/primary/2021/12/57312.jpeg?dpr=1&w=400" alt="Product 6" class="product-image">
                        <h2 class="product-title">Personalised Kid Keychain</h2>
                ...
                <div id="product7">
                    <a href="husband7.jsp">
                        <img src="https://assets.winni.in/product/primary/2023/11/91813.jpeg?dpr=1&w=400" alt="Product 7" class="product-image">
                        <h2 class="product-title">Butterscotch Flaversome Cake</h2>
                ...
                <div id="product8">
                    <a href="husband8.jsp">
                        <img src="https://assets.winni.in/product/primary/2023/5/84654.jpeg?dpr=1&w=400" alt="Product 8" class="product-image">
                        <h2 class="product-title">Pleasent Smile Personalised Kids Bottle</h2>
